    ...
    items: [
      {
        ...
        a: "Цены начинаются от 9 900 ₽ за базовый пакет с AI-вокалом. Пакет с живым вокалом и передачей авторских прав — 19 000 ₽.",
      },
      {
    ...
    items: [
      {
        ...
        a: "AI-вокал — современное звучание, быстрее (2–3 дня), дешевле (от 9 900 ₽), подходит для личных подарков. Живой вокал — настоящие эмоции профессионального исполнителя, студийная запись, 5–7 дней, от 19 000 ₽. Идеально для свадеб и публичных выступлений.",
      },
      {
    ...
    items: [
      {
        ...
        a: ["Базовые пакеты (9 900–14 900 ₽): только для личного использования (подарок, семейное видео)", "Пакеты с передачей прав (от 14 900 ₽): вы получаете коммерческие права и можете использовать в рекламе, соцсетях, на YouTube"],
      },
      {
